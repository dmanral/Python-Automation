...
for character in message.upper():
    count.setdefault(character, 0)      # if the value hasnt been counted, then set it to 0.
    count[character] = count[character] + 1

userChar = input('What character do you want to count? ')

for characters in count:
      if characters == userChar.upper():
            print('The character ' + characters + ' is written ' + str(count[characters]) + ' times.')
